...
public class DodajAdminaDialog extends JDialog {
    ...
    public DodajAdminaDialog(JFrame parent, boolean modal) {
        super(parent, "Dodaj administratora", modal);
        setSize(400, 500);
        ...
        btnDodaj.addActionListener(e -> {
            try {
                ...
                AdminMetode.dodajAdmina("podaci/admini.csv",
                        tfIme.getText(),
                        tfPrezime.getText(),
                ...
                JOptionPane.showMessageDialog(this, "Administrator uspešno dodat!");
                dispose();
